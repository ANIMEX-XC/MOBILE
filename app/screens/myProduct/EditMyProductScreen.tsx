...
type EditMyProductScreenPropsTypes = NativeStackScreenProps<
  INavigationParamList,
  "EditMyProduct"
>;

export default function EditMyProductScreen({
  navigation,
}: EditMyProductScreenPropsTypes) {
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <View className="p-4 bg-white border-t border-gray-100">
        ...
        >
          <ButtonText>Update Listing</ButtonText>
        </Button>
      </View>
    </View>
  );
